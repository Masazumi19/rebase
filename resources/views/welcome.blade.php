            ...
            <div class="h-full flex flex-auto bg-purple-900 text-white bg-no-repeat bg-cover relative bg-image">
                <div
                    ...
                    <div class="w-4/5 z-10">
                        <h2 class="text-xl xl:text-3xl italic mb-6">welcome to</h2>
                        <div class="text-5xl sm:text-6xl xl:text-8xl font-bold leading-tight mb-6">rebase<br>
                        </div>
                        <div class="sm:text-sm xl:text-md text-gray-200 font-normal">Best price , Japanese furniture,
                            </div>
                    </div>
                    <div
